  ...
  function polybius(input, encode = true) {
    ...
    if (!encode) {
      ...
      for (word of messageArr) {
        lettersArr.push(word.match(/.{2}/g)); /*new array where each index is an array of number pairs representing each letter. each index of lettersArr is one word of the message */
      }
      ...
      let final = decodedArr.join(" "); /*join words back into sentence maintaining spaces*/
      return final;
    }
